...
import { BsAlignCenter, BsChevronCompactLeft, BsChevronCompactRight } from 'react-icons/bs';
import { RxDotFilled } from 'react-icons/rx';
import { useEffect } from 'react';
import img from "../component/Screenshot_2023-09-10_172407-removebg-preview.png"
...
const Home = () => {
    ...
    const slides = [
        {
          ...
          text:'lorem lorem loremloremlorem lorem  lorem  lorem  lorem  lorem  lorem  lorem  lorem 1 '
        },
        {
          url: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2670&q=80',
          text:'lorem lorem loremloremlorem lorem  lorem  lorem  lorem  lorem  lorem  lorem  lorem 2'
        },
        {
          url: 'https://images.unsplash.com/photo-1661961112951-f2bfd1f253ce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2672&q=80',
          text:'lorem lorem loremloremlorem lorem  lorem  lorem  lorem  lorem  lorem  lorem  lorem 3'
        },
    
        {
          url: 'https://images.unsplash.com/photo-1512756290469-ec264b7fbf87?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2253&q=80',
          text:'lorem lorem loremloremlorem lorem  lorem  lorem  lorem  lorem  lorem  lorem  lorem 4'
        },
        {
          url: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2671&q=80',
          text:'lorem lorem loremloremlorem lorem  lorem  lorem  lorem  lorem  lorem  lorem  lorem 5'
        },
      ];
    
      const dotColors = ['#FF5733', '#33FF57', '#5733FF', '#FF33E9', '#33E9FF'];
  ...
  return (
    <>
    <div className='max-w-[1400px] lg:h-[475px] h-[350px] w-full m-auto  relative group'>
      <div style={{ backgroundImage: `url(${slides[currentIndex].url})` }} className='w-full h-full  justify-center items-center  flex bg-center bg-cover duration-500'  >
      <div className='bg-white/40 lg:w-[200px] lg:h-[130px] h-[100px] w-full text-left pb-64  mb-0  '>{slides[currentIndex].text} </div>
      </div>
      {/* Left Arrow */}
      <div className=' absolute top-[50%] -translate-x-0 translate-y-[-50%] left-0 text-2xl  p-2 bg-black/50 text-white cursor-pointer '>
        <BsChevronCompactLeft onClick={prevSlide} size={30} />
      </div>
      {/* Right Arrow */}
      <div className=' absolute top-[50%] -translate-x-0 translate-y-[-50%] right-0 text-2xl  p-2 bg-black/50 text-white cursor-pointer'>
        <BsChevronCompactRight onClick={nextSlide} size={30}/>
      </div>
      <div className='flex  justify-center bg-black/50 w-[200px]  ml-[400px] mt-[-100px] hidden lg:flex md:flex'>
        {slides.map((slide, slideIndex) => (
           <div
           key={slideIndex}
           onClick={() => goToSlide(slideIndex)}
           className='text-2xl cursor-pointer'
           style={{ color: currentIndex === slideIndex ? dotColors[slideIndex % dotColors.length] : '#000' }}
         >
            <RxDotFilled />
          </div>
        ))}
    ...
    <section className="py-3 lg:20  bg-gray-100  text-gray-900">
	<div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 md:px-24 xl:px-48">
		<h1 className="text-5xl font-bold leadi text-left">Sign up now</h1>
		<p className="text-xl font-medium text-left">
            At a assumenda quas cum earum ut itaque commodi saepe rem aspernatur quam natus quis nihil quod,
             hic explicabo doloribus magnam neque, exercitationem eius sunt!
             </p>
		<div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:space-x-8">
			<button className="px-32 py-3 text-lg font-semibold rounded  bg-violet-400  text-gray-900">Get started</button>
			<button className="px-32 py-3 text-lg font-normal border rounded  bg-gray-100  text-gray-900  border-gray-300">Learn more</button>
		</div>
	</div>
</section>
...
<div className='grid grid-cols-1 gap-0 lg:grid-cols-2 sm:grid-cols-1 p-3 lg:p-20   bg-gray-100'>

<div className='  bg-gray-100'>
    <div className="max-w-screen-xl p-3 mx-auto  bg-gray-100  text-gray-900">
    <div className="space-y-2 text-left">
			<h2 className="text-3xl font-bold">Latest publications</h2>
			 
		</div>
       
	<div className="grid grid-cols-1 gap-4 lg:grid-cols-1 sm:grid-cols-1">
				<div className="flex px-1 py-4 ">
					<img alt="" className="flex-shrink-0 object-cover  w-20 h-20 lg:w-36 lg:h-36 mr-4 bg-gray-500" src="https://source.unsplash.com/random/247x327" />
					<div className="flex flex-col flex-grow">
						<a rel="noopener noreferrer" href="#" className="font-serif hover:underline">Suspendisse potenti.</a>
						<p className="mt-auto text-xs dark:text-gray-400 py-4">37 minutes ago
							<a rel="noopener noreferrer" href="#" className="block text-blue-400 lg:ml-2 lg:inline hover:underline">Business</a>
						</p>
						<p>
							Author
						</p>
						<p className='py-4 overflow-hidden max-h-[7.5em] text-overflow-ellipsis'>
						jfdgdfhgbhhdfvbfhd  jhbh hjbvbhfg hjbfhbgf hjfghf hjjbbhf dhbgfb hdbgf hjbdbjfdgdfhgbhhdfvbfhd  jhbh hjbvbhfg hjbfhbgf hjfghf hjjbbhf dhbgfb hdbgf hjbdbjfdgdfhgbhhdfvbfhd  jhbh hjbvbhfg hjbfhbgf hjfghf hjjbbhf dhbgfb hdbgf hjbdbjfdgdfhgbhhdfvbfhd  jhbh hjbvbhfg hjbfhbgf hjfghf hjjbbhf dhbgfb hdbgf hjbdb jfdgdfhgbhhdfvbfhd  jhbh hjbvbhfg hjbfhbgf hjfghf hjjbbhf dhbgfb hdbgf hjbdb
						</p>
						<p className='pt-4'>
...
<div className='  bg-gray-100'>
    ...
    <div className="max-w-screen-xl p-3 lg:p-20 mx-auto  bg-gray-100  text-gray-900">
	<div className="space-y-2 text-left">
			<h2 className="text-3xl font-bold">Our Works</h2>
			<p className="font-serif text-2xl  ">Qualisque erroribus usu at, duo te agam soluta muciusQualisque erroribus usu at, duo te agam soluta muciusQualisque erroribus usu at, duo te agam soluta muciusQualisque erroribus usu at, duo te agam soluta muciusQualisque erroribus usu at, duo te agam soluta muciusQualisque erroribus usu at, duo te agam soluta mucius.</p>
		</div>
	<div className="grid grid-cols-1 gap-8 lg:grid-cols-4 sm:grid-cols-2">
		<div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-[16rem]  bg-gray-500" style={{backgroundImage: "url('https://source.unsplash.com/random/640x480')"}}>
		...
		<div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-[16rem]  bg-gray-500" style={{backgroundImage: "url('https://source.unsplash.com/random/243x320')"}}>
			<div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b  via-transparent  from-gray-900  to-gray-900"></div>
			<div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
			</div>
			<h2 className="z-10 p-5">
...
<section className="p-3 lg:p-20 bg-gray-800 text-gray-100">
      ...
      {isSmallScreen ? (
        ...
        infiniteLoop={true}
        autoPlay={true}
        interval={3000} // Adjust the autoplay interval as needed (in milliseconds)
        stopOnHover={false} // Remove this line if you want to pause autoplay on hover
        centerMode={true}
        ...
        // Render individual partner logos for larger screens
...
{/* -------------------News ------------------------------- */}
<div className='grid grid-cols-1  md:grid-cols-1 lg:grid-cols-2 p-3 lg:p-20 gap-12'>


<section className="  bg-gray-100  text-gray-900  lg:w-[750px]">
	<div className="container p-3 lg:p- mx-auto space-y-8">
		<div className="space-y-2 text-left">
			<h2 className="text-3xl font-bold">Partem reprimique an pro</h2>
			 
		</div>
		<div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-2 lg:grid-cols-2">
			<article className="flex flex-col  bg-gray-100 text-gray-900 drop-shadow-lg">
...
<div className='  bg-gray-100 ml-0   lg:ml-44'>
    <div className="container p-3 lg:p- mx-auto space-y-8">
    <div className="space-y-2 text-left">
	...
	<div className="grid grid-cols-1 gap-2 lg:grid-cols-1 sm:grid-cols-   w-64 ">
				<div className="flex px-1 py-1 ">
					<img alt="" className="flex-shrink-0 object-cover w-20 h-20 lg:w-30 lg:h-30 mr-4 bg-gray-500" src="https://source.unsplash.com/random/247x327" />
					<div className="flex flex-col flex-grow">
						<a rel="noopener noreferrer" href="#" className="font-serif hover:underline">Suspendisse potenti.</a>
						<p className="mt-auto text-xs dark:text-gray-400 py-4">37 minutes ago
							<a rel="noopener noreferrer" href="#" className="block text-blue-400 lg:ml-2 lg:inline hover:underline">Business</a>
...
<div className='  bg-gray-800'>
    <div className="max-w-screen-xl p-3 lg:p-20 mx-auto  bg-gray-800  text-gray-100">
	<div className="grid grid-cols-1 gap-8 lg:grid-cols-4 sm:grid-cols-2">
		<div className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-[16rem]  bg-gray-500" style={{backgroundImage: "url('https://source.unsplash.com/random/640x480')"}}>
			<div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b  via-transparent  from-gray-900  to-gray-900"></div>
			<div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
...
<div className="space-y-2 text-center pt-14">
			<h2 className="text-3xl font-bold">Work with us </h2>
			 
		</div>
	<div className="container flex p-3 lg:p-20  flex-col justify-center mx-auto  lg:flex-row lg:justify-between">
		...
		<div className="flex flex-col justify-center p-3 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			<h1 className="lg:text-6xl font-bold leadi text-4xl">Ac mattis dsknfjdshfkjhdjk
			</h1>
            {/* <h1 className="text-3xl font-bold leadi sm:text-6xl">Ac mattis
